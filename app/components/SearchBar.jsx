  ...
  return (
    <div
      className={`p-4  me-0 md:mx-5 md:w-[500px] xxs:px-0 transition-all duration-300 ${
        isFocused
          ? "absolute md:static  top-10 left-0 w-full lg:w-[500px] xs:z-30 bg-white "
          : ""
      }`}
    >
      <div className="relative group">
        <input
          ...
          onBlur={handleBlur}
          placeholder="Search..."
          className="pl-10 text-sm border-gray-500 pr-4 py-1.5 xl:py-2.5 w-full border-b focus:outline-none transition-all duration-300"
        />
        ...
        {inp !== "" && (
          <div
            onClick={() => setInp("")}
            className="cursor-pointer  absolute inset-y-0 right-0 flex items-center pe-3"
          >
